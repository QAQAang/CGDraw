...
- (void)creatArrow{
    ...
    [path addArcWithCenter:self.center radius:10 startAngle:0.0 endAngle:180.0 clockwise:YES];
    path.lineWidth = 1;
    [[UIColor blackColor] setStroke];
    [path stroke];
    UIBezierPath *arrow = [UIBezierPath bezierPath];
    [arrow moveToPoint:CGPointMake(self.center.x, self.center.y - 5)];
    [arrow addLineToPoint:CGPointMake(self.center.x, self.center.y + 5)];
    [arrow addLineToPoint:CGPointMake(self.center.x - 4, self.center.y + 1)];
    [arrow addLineToPoint:CGPointMake(self.center.x, self.center.y + 5)];
    [arrow addLineToPoint:CGPointMake(self.center.x + 4, self.center.y + 1)];
    arrow.lineWidth = 1;
    [[UIColor blackColor] setStroke];
